...
try:
    ...
    from APP_FILMS_164.adresses import gestion_adresses_wtf_forms

    from APP_FILMS_164.acheter import gestion_acheter_crud
    from APP_FILMS_164.acheter import gestion_acheter_wtf_forms
